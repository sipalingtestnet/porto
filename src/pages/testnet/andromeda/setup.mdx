...
```
wget -O andromeda.sh https://raw.githubusercontent.com/sipalingtestnet/andromeda/main/andromeda.sh && chmod +x andromeda.sh && ./andromeda.sh
```
<h2>OR</h2>
...
### Referensi Dari:
>- [Nodex Capital](https://github.com/nodexcapital/)
>- [sxlzptprjkt](https://services.sxlzptprjkt.xyz)
>- [Aidil Fahmi](https://github.com/kj89/)
