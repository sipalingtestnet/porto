...
### Install otomatis
```
wget -O gitopia.sh https://raw.githubusercontent.com/0xrevo/mainnet-guide/main/gitopia/gitopia.sh && chmod +x gitopia.sh && ./gitopia.sh
```
...
SNAP_RPC="https://gitopia-mainnet-rpc.polkachu.com:443"
